...
{
    public partial class UC_LenhSXGiaoDich : UserControl
    {
        public UC_LenhSXGiaoDich(frmLenhSanXuat main)
        {
            InitializeComponent();
            ...
            ReadXml_User();
            //bbiDelete.Enabled = new SYS_USER_RULEController().SYS_USER_RULE_GetbyUserID(UserID, "bbiLSXGD").AllowDelete;
            //bbiPrint.Enabled = new SYS_USER_RULEController().SYS_USER_RULE_GetbyUserID(UserID, "bbiLSXGD").AllowPrint;
            #endregion
        }
        string UserID = "";
